...
final class FreezePowerCommand extends AbstractFactionActionCommand
{
    public function __construct(
        private readonly FactionPowerActionService $powerActionService,
        FactionManager $factionManager,
    ) {
        parent::__construct('freezepower', 'Freeze faction power');
        $this->factionManager = $factionManager;
        $this->setPermission(Permissions::FACTIONS_COMMAND_FREEZEPOWER->value);
    }

    public function getPermission(): string
    {
        return Permissions::FACTIONS_COMMAND_FREEZEPOWER->value;
    }
