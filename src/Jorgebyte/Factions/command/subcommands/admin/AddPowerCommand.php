...
final class AddPowerCommand extends AbstractFactionActionCommand
{
    public function __construct(
        private readonly FactionPowerActionService $powerActionService,
        FactionManager $factionManager,
    ) {
        parent::__construct('addpower', 'Add power to a faction');
        $this->factionManager = $factionManager;
        $this->setPermission(Permissions::FACTIONS_COMMAND_ADDPOWER->value);
    }

    public function getPermission(): string
    {
        return Permissions::FACTIONS_COMMAND_ADDPOWER->value;
    }
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        Await::f2c(function () use ($sender, $factionName, $amount) {
            ...
            $result = $this->powerActionService->addPower($faction, $amount);
