...
final class UnfreezePowerCommand extends AbstractFactionActionCommand
{
    public function __construct(
        private readonly FactionPowerActionService $powerActionService,
        FactionManager $factionManager,
    ) {
        parent::__construct('unfreezepower', 'Unfreeze faction power');
        $this->factionManager = $factionManager;
        $this->setPermission(Permissions::FACTIONS_COMMAND_UNFREEZEPOWER->value);
    }

    public function getPermission(): string
    {
        return Permissions::FACTIONS_COMMAND_UNFREEZEPOWER->value;
    }
